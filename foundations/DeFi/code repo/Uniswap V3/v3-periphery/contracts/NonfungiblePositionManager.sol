    ...
    SelfPermit
{
    ...
    /// @inheritdoc INonfungiblePositionManager
    //@ztmy This position must be a position that was created by calling mint
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        if (position.liquidity > 0) {
            // @ztmy
            // Calling burn updates tokensOwed
            //The third parameter is passed in 0, which means that there is no real reduction in liquidity
